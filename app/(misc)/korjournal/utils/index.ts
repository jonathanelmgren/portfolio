...
export function getPreviousMonthDates() {
    ...
    const lastDayOfPreviousMonth = new Date(currentDate.getFullYear(), currentMonth, 0); // 0th day of current month is last day of previous month
...
export const getAllWeekNumbersBetweenDates = (startDate: Date, endDate: Date) => {
