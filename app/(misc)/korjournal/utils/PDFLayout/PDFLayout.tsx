        ...
        <div>
            ...
            <div>
                ...
                <span style={{ marginLeft: '16px' }}>
                    År: <strong>{fromYear === toYear ? fromYear : `${fromYear} - ${toYear}`}</strong>
                </span>
                <span style={{ marginLeft: '16px' }}>
                    Månad: <strong>{fromMonth === toMonth ? fromMonth : `${fromMonth} - ${toMonth}`}</strong>
                </span>
            </div>
            <div style={{ marginTop: '16px' }}>
                <span>
                    Totalt antal körda mil: {data.totalKm}km
                </span>
                <span style={{ marginLeft: '16px' }}>
                ...
                <span style={{ marginLeft: '16px' }}>
                    Total ersättning: <strong>{data.totalKmInWorkTrips * MILEAGE_COMPENSATION}:-</strong>
                </span>
            </div>
            <table>
                <thead>
