...
export const JournalForm = () => {
  ...
  const formMethods = useForm<TDriversLogGenerator>({
    ...
    defaultValues: {
      ...defaultFormValues,
      dates: { from: firstDayOfPreviousMonth, to: lastDayOfPreviousMonth },
    },
  });
        ...
        <div className="flex gap-4">
          ...
          <div className="grow space-y-2">
                ...
                <div className="flex gap-4">
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormControl>
                          <Input {...field} placeholder="Start adress" />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormControl>
                          <Input {...field} placeholder="End adress" />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input {...field} placeholder="Trip in km" />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                      ...
                      render={({ field }) => {
                        ...
                        return (
                          <FormItem className="">
                            ...
                            <FormLabel
                              className={cn(
                                "cursor-pointer font-normal block p-2 border-[1px] rounded-md",
                ...
                <FormField
                  ...
                  render={({ field: { value, onChange } }) => (
                    <FormItem>
                      ...
                      <FormDescription>
                        How many percent of the total trips should be of this
                        trip?
                      </FormDescription>
            ...
            <Button
              ...
              onClick={addTrip}
            >
              <PlusIcon className="w-4 aspect-square" /> Add trip
            </Button>
          </div>
        </div>
