...
export const WhatIDo = () => {
    ...
    return (
        <div className='overflow-hidden lg:overflow-visible flex flex-col-reverse md:flex-row h-fit justify-center bg-white shadow-lg lg:p-6 max-w-6xl relative'>
            ...
            <div onClick={() => setMobileTools(!mobileTools)} className={`transition-all duration-300 bg-primary text-white lg:-m-8 p-2 w-full text-sm font-thin absolute lg:p-6 lg:static bottom-0 overflow-hidden ${mobileTools ? 'translate-y-[83%]' : 'translate-y-0'} lg:translate-y-0`}>
